'use strict';
// hong.fun static brand-kit rasterizer. For each _studio/out/lethe-*.html, drive headless Chrome
// with --screenshot at the asset's native size, saving lethe-*.png to the Desktop.
...
for (const name of names) {
  ...
  const udd = path.join(os.tmpdir(), 'lethechrome_' + name + '_' + Date.now());
